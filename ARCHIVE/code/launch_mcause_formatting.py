...
class MCauseLauncher(object):
    ...
    def prep_run_filters(self):
        ...
        # 12/18/2019 drop PHL_HICC-- Mohsen says these data are claims and biased
        drop_sources = ["EUROPE_INJ_POISON", "PHL_HICC"]
        datasets = datasets.loc[~(datasets['source'].isin(drop_sources))]
